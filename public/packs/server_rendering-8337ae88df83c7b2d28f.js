...
throw new Error("Module build failed: SyntaxError: Unexpected token (7:38)\n\n   5 |     debugger\n   6 |     return (<div>\n>  7 |       {this.props.options.map(label =>)}\n     |                                       ^\n   8 |     </div>);\n   9 | \n  10 |   }\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Options___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__Options__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ title: response.output.generic[0].text });
      });
    }
  }, {
    key: "sendMessage",
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { title: this.state.title }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Options__["default"], { options: this.state.options })
      );
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-8337ae88df83c7b2d28f.js.map