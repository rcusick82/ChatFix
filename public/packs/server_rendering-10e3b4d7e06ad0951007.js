...
throw new Error("Module build failed: SyntaxError: this is a reserved word (30:19)\n\n  28 |     // console.log('send message firing')\n  29 |     text = JSON.stringify(text)\n> 30 |     this.setState({this.state.welcomeMessage: false})\n     |                    ^\n  31 |     $.post(\"/conversations/add_message\", {\n  32 |       input: text\n  33 |     }, response => {\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-10e3b4d7e06ad0951007.js.map