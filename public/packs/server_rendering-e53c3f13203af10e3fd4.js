...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function loadUserInfo(input) {
      ...
      $.post("/conversations/generate_sms", userInput, function (response) {
    ...
    value: function sendMessage(input) {
      ...
      $.post("/conversations/add_message", payload, function (response) {
        ...
        if (dialog_node.startsWith("node_6") && input.text == "yes") _this2.launchModal();
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-e53c3f13203af10e3fd4.js.map