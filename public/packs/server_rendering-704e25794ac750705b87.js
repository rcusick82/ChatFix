  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ options: response.output.generic[0].options });
        // this.setState({title: response.output.generic[0].text})
      });
    }
  }, {
    key: "sendMessage",
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-704e25794ac750705b87.js.map