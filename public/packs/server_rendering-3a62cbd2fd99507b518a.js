...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected : (45:48)\n\n  43 |     return (<div>\n  44 |       <Message title={this.state.response\n> 45 |           ? this.state.response[1].title || null} welcomeMessage={this.state.response[0].text}/>\n     |                                                 ^\n  46 |       <Options options={this.state.response[1].options}/>\n  47 | \n  48 |       <ChatForm sendMessage={this.sendMessage}/> {this.state.chatItems.map(item => <Message item={item}/>)}\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-3a62cbd2fd99507b518a.js.map