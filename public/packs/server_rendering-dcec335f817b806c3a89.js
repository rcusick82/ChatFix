...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected ] (38:41)\n\n  36 |     }, response => {\n  37 |       this.setState({\n> 38 |         text: response.output.generic[0. text})})}\n     |                                          ^\n  39 | \n  40 |     sendMessage(text) {\n  41 |       console.log('send message firing')\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-dcec335f817b806c3a89.js.map