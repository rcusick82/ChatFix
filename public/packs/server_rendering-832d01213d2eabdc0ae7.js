...
throw new Error("Module build failed: SyntaxError: this is a reserved word (23:6)\n\n  21 |     $.post(\"/conversations/add_message\", {\n  22 |       input: this.state.title,\n> 23 |       this.state.options\n     |       ^\n  24 |     }, response => {\n  25 |       this.setState({title: response.output.generic[0].text, options: response.output.generic[0].options})\n  26 | \n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-832d01213d2eabdc0ae7.js.map