    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "p",
          null,
          this.props.welcomeMessage ? 'Hello, thank you for letting me assist you today!' : null
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "p",
          null,
...
/* 7 */
/*!**********************************************!*\
  !*** ./app/javascript/components/Options.js ***!
  \**********************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Options__ = __webpack_require__(/*! ./Options */ 7);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ response: response.output.generic[1] });
      });
      // $.post("/conversations/add_message", {
      //   input: this.state.title
      // }, response => {
      //   this.setState({title: response.output.generic[1].title})
      //
      // })
      // $.post("/conversations/add_message", {
      //   input: this.state.text
      // }, response => {
      //   this.setState({text: response.output.generic[0].text})
      //
      // })
    }
  }, {
    ...
    value: function sendMessage(text) {
      ...
      $.post("/conversations/add_message", {
        ...
        _this3.setState({ title: response.output.generic[0].title, options: response.output.generic[0].options });
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { title: this.state.response.title, welcomeMessage: this.state.welcomeMessage }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Options__["default"], { options: this.state.response.options }),
        " "
      );
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-548362169924cbf9bf5e.js.map