  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ text: response.output.generic[0].text, title: response.output.generic[0].title, options: response.output.generic[0].options });
      });
    }
  }, {
    key: "sendMessage",
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-e84fa21523802ff51bf3.js.map