...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (14:12)\n\n  12 |         this.props.watsonData.output.generic[1]\n  13 |           ? <p>{this.props.watsonData.output.generic[0].text}</p>\n> 14 |             <p>{this.props.watsonData.output.generic[1].title}</p>\n     |             ^\n  15 |           : <p>{this.props.watsonData.output.generic[0].title}</p>\n  16 |       }\n  17 | \n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-e8cf4db500e309f27ae0.js.map