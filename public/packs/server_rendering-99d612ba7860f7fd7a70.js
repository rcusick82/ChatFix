...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(text) {
      console.log('test start', text);
      text.conversation_id = this.state.conversation_id;
      console.log('test added', text);
      // text = JSON.stringify(text)
      // let conversation_id = JSON.stringify(this.state.conversation_id)
      // console.log('v', conversation_id)
      // $.post("/conversations/add_message", {
      //   input: text,
      //   conversation_id: conversation_id
      // }, response => {
      //    here, you want setState and update the chatItems
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-99d612ba7860f7fd7a70.js.map