  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ response: response.output.generic });
      });
    }
  }, {
    key: "sendMessage",
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { title: this.state.watsonData ? this.state.watsonData[1].title : null, welcomeMessage: this.state.response ? this.state.response[0].text : null }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Options__["default"], { options: this.state.response ? this.state.response[1].options : null }),
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-8197baa7473cdaad2a6a.js.map