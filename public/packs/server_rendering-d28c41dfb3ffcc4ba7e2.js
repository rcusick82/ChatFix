...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected jsxTagEnd (46:84)\n\n  44 |       <ChatForm sendMessage={this.sendMessage}/> {this.state.chatItems.map(item => <Message item={item}/>)}\n  45 |       {/* this is not working */}\n> 46 |       <Options options={this.state.options.map(label => <Message label={label}/>)} /div>);\n     |                                                                                     ^\n  47 |   }\n  48 | }\n  49 | \n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-d28c41dfb3ffcc4ba7e2.js.map