  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        input: this.state.options
      }, function (response) {
        _this2.setState({ options: response.output.generic[1].options });
      });
      $.post("/conversations/add_message", {
        input: this.state.title
      }, function (response) {
        _this2.setState({ title: response.output.generic[1].title });
      });
      $.post("/conversations/add_message", {
        input: this.state.text
      }, function (response) {
        _this2.setState({ text: response.output.generic[0].text });
      });
    }
  }, {
    key: "sendMessage",
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Text, { text: this.state.text })
      );
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-f48fb30e863f065050a0.js.map