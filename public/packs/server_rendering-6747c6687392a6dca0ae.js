  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(input) {
      ...
      $.post("/conversations/add_message", payload, function (response) {
        ...
        _this2.setState({
          watsonDataLog: [].concat(_toConsumableArray(_this2.state.watsonDataLog), [response])
        });
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        this.state.watsonDataLog.map(watsonData, function (index) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { key: watsonData.context.conversation_id + index, watsonData: watsonData });
        }),
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-6747c6687392a6dca0ae.js.map