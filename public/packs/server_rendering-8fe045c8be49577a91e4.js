  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState((_this2$setState = { title: response.output.generic[0].text }, _defineProperty(_this2$setState, "title", response.output.generic[0].title), _defineProperty(_this2$setState, "options", response.output.generic[0].options), _this2$setState));
      });
    }
  }, {
    key: "sendMessage",
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-8fe045c8be49577a91e4.js.map