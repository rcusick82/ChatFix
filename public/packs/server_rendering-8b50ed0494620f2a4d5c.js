  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ options: response.output.generic[1].options, title: response.output.generic[1].title });
      });
      // $.post("/conversations/add_message", {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-8b50ed0494620f2a4d5c.js.map