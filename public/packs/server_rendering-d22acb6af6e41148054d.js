  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(text) {
      ...
      text = JSON.stringify(text) || $.post("/conversations/add_message", {
        ...
        self.setState({ title: response.output.generic[0].title, options: response.output.generic[0].options });
      });
    }
  }, {
    key: "render",
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-d22acb6af6e41148054d.js.map