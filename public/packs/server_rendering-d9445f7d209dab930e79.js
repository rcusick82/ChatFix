...
var Messages = function (_React$Component) {
  ...
  _createClass(Messages, [{
    ...
    value: function render() {
      ...
      } else if (generic.length > 0 && generic[0].response_type == "options") {
  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(input) {
      ...
      $.post("/conversations/add_message", payload, function (response) {
        ...
        if (dialog_node == "6" && input == "yes") _this2.launchModal();
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-d9445f7d209dab930e79.js.map