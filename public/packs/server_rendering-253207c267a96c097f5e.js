...
var Chat = function (_React$Component) {
  ...
  function Chat(props) {
    ...
    _this.state = {
      ...
      system: props.watsonData.context.system,
      context: props.watsonData.context
    };
  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(input) {
      ...
      input.context = this.state.context;
      console.log('typeof', _typeof(input.context));
      // input.converstaion_id = this.state.converstaion_id
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-253207c267a96c097f5e.js.map