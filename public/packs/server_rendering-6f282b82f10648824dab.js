...
/* 5 */
/*!***********************************************!*\
  !*** ./app/javascript/components/ChatForm.js ***!
  \***********************************************/
  ...
  _createClass(ChatForm, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: "clearfix margin-left chat-input" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.inputText, onChange: function onChange(event) {
            _this2.setState({ inputText: event.target.value });
          } }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { "class": "input-group input-group-lg" },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { "class": "input-group-prepend" }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "submit", "class": "form-control", "aria-label": "Large", "aria-describedby": "inputGroup-sizing-sm" })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "submit", className: "btn btn-primary", onClick: this.handleSubmit })
      );
    }
  }]);
...
/* 6 */
/*!**********************************************!*\
  !*** ./app/javascript/components/Message.js ***!
  \**********************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(/*! prop-types */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Option__ = __webpack_require__(/*! ./Option */ 7);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Messages = function (_React$Component) {
  ...
  _createClass(Messages, [{
    key: "render",
    value: function render() {
      var generic = this.props.watsonData.output.generic;
      var options = void 0;

      if (generic.length > 1) {
        options = generic[1].options.map(function (option, index) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Option__["default"], { key: index, option: option });
        });
      } else if (generic.length > 0 && generic[0].response_type == "option") {
        options = generic[0].options.map(function (option, index) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Option__["default"], { key: index, option: option });
        });
      }
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: "speech-bubble clearfix" },
        this.props.watsonData.output.generic[1] ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "chatbot" }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "h2",
            { className: "welcome-text" },
            this.props.watsonData.output.generic[0].text
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "h3",
            { className: "watson-question" },
            this.props.watsonData.output.generic[1].title
          ),
          options
        ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "h3",
            { className: "watson-question" },
            this.props.watsonData.output.generic[0].title
          ),
          options
        )
      );
...
/* 7 */
/*!*********************************************!*\
  !*** ./app/javascript/components/Option.js ***!
  \*********************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Option = function (_React$Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: "watson-options d-inline-block" },
...
/* 8 */
/*!*******************************************!*\
  !*** ./app/javascript/components/Chat.js ***!
  \*******************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(/*! prop-types */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ChatForm__ = __webpack_require__(/*! ./ChatForm */ 5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Message__ = __webpack_require__(/*! ./Message */ 6);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    key: "loadUserInfo",
    value: function loadUserInfo(input) {
      var userInput = {
        phone_number: input,
        zip_code: input
      };
      $.post("/conversations/generate_message", userInput, function (response) {
    ...
    value: function sendMessage(input) {
      ...
      $.post("/conversations/add_message", payload, function (response) {

        var dialog_node = _this2.state.watsonData.context.system.dialog_stack[0].dialog_node;

        if (dialog_node.startsWith("node") && input.text == "yes") {
          $('#chat_items').val(JSON.stringify(_this2.state.chatItems));
          _this2.launchModal();
        }

        console.log('node', dialog_node);
        console.log('response', response);
        _this2.setState({ watsonData: response });
        _this2.setState({
          watsonDataLog: [].concat(_toConsumableArray(_this2.state.watsonDataLog), [_this2.state.watsonData.input.text, response])
        });
        _this2.state.chatItems.push(_this2.state.watsonData.input.text, _this2.state.watsonData.output.generic[0].title);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          this.state.watsonDataLog.map(function (item, index) {
            return typeof item == "string" ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "div",
              { className: "speech-bubble user-speech-bubble clearfix" },
              item
            ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { key: index, watsonData: item });
          })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__ChatForm__["default"], { sendMessage: this.sendMessage })
      );
    }
  }]);
...
var ReactDOMServer = __webpack_require__(/*! react-dom/server */ 20)

var detectEvents = __webpack_require__(/*! ./src/events/detect */ 22)
var constructorFromGlobal = __webpack_require__(/*! ./src/getConstructor/fromGlobal */ 17)
var constructorFromRequireContextWithGlobalFallback = __webpack_require__(/*! ./src/getConstructor/fromRequireContextWithGlobalFallback */ 28)
...
var nativeEvents = __webpack_require__(/*! ./native */ 23)
var pjaxEvents = __webpack_require__(/*! ./pjax */ 24)
var turbolinksEvents = __webpack_require__(/*! ./turbolinks */ 25)
var turbolinksClassicDeprecatedEvents = __webpack_require__(/*! ./turbolinksClassicDeprecated */ 26)
var turbolinksClassicEvents = __webpack_require__(/*! ./turbolinksClassic */ 27)
...
var fromGlobal = __webpack_require__(/*! ./fromGlobal */ 17)
var fromRequireContext = __webpack_require__(/*! ./fromRequireContext */ 29)
...
var componentRequireContext = __webpack_require__(/*! components */ 18);
var ReactRailsUJS = __webpack_require__(/*! react_ujs */ 19);
ReactRailsUJS.useContext(componentRequireContext);

/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-6f282b82f10648824dab.js.map