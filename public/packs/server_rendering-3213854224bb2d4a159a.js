  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(text) {
      ...
      $.post("/conversations/add_message", {
        ...
        // this.setState({title: response.output.generic[0].title, options: response.output.generic[0].options})
    ...
    key: "render",
    value: function render() {
      console.log('state', this.state.watsonData);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-3213854224bb2d4a159a.js.map