...
var Messages = function (_React$Component) {
  ...
  _createClass(Messages, [{
    key: "render",
    value: function render() {
      var options = this.props.watsonData.output.generic[1].options.map(function (option, index) {
...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      //   input: ''
      // }, response => {
      //   this.setState({response: response.output.generic})
      // })
    }
  }, {
    key: "sendMessage",
    value: function sendMessage(text) {
      ...
      // this.setState({this.state.welcomeMessage: false})
      // $.post("/conversations/add_message", {
      //   input: text
      // }, response => {
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        this.state.chatItems.map(function (item) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { item: item });
        })
      );
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-bfa06000ace0dd5437d5.js.map