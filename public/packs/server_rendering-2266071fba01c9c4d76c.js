...
throw new Error("Module build failed: SyntaxError: Unexpected token (46:15)\n\n  44 |       <ChatForm sendMessage={this.sendMessage}/> {this.state.chatItems.map(item => <Message item={item}/>)}\n  45 |       {/* this is not working */}\n> 46 |       <Options ) options={this.state.options.map(label => <Message label={label}/>)}>\n     |                ^\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-2266071fba01c9c4d76c.js.map