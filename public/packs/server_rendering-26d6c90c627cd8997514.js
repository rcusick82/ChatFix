  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(text) {
      ...
      $.post("/conversations/add_message", {
        ...
        _this3.setState({ title: response.output.generic[0].title, options: response.output.generic[0].options.label });
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Options__["default"], { options: this.state.label })
      );
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-26d6c90c627cd8997514.js.map