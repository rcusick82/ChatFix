  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { "class": "zip_code", type: "text", value: this.state.zip_code, onChange: function onChange(event) {
            _this2.setState({ zip_code: event.target.value });
          } }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { "class": "phone_number", type: "text", value: this.state.phone_number, onChange: function onChange(event) {
            _this2.setState({ phone_number: event.target.value });
          } }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "submit_tag", className: "btn btn-primary", onClick: this.postInfo })
      );
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Modal__ = __webpack_require__(/*! ./Modal */ 8);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  _createClass(Chat, [{
    ...
    value: function sendMessage(input) {
      ...
      $.post("/conversations/add_message", payload, function (response) {
        ...
        if (dialog_node.startsWith("node") && input.text == "yes") _this2.launchModal();
    ...
    value: function render() {
      ...
      var chatItems = this.state.chatItems.map(function (item, index) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { key: index },
          item
      ...
      $.post('/conversations/chat_items', chatItems, function (response) {
        console.log(chatItems);
      });
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Message__["default"], { watsonData: this.state.watsonData }),
...
var ReactDOMServer = __webpack_require__(/*! react-dom/server */ 21)

var detectEvents = __webpack_require__(/*! ./src/events/detect */ 23)
var constructorFromGlobal = __webpack_require__(/*! ./src/getConstructor/fromGlobal */ 18)
var constructorFromRequireContextWithGlobalFallback = __webpack_require__(/*! ./src/getConstructor/fromRequireContextWithGlobalFallback */ 29)
...
if (false) {
  ...
  module.exports = __webpack_require__(/*! ./cjs/react-dom-server.browser.development.js */ 22);
}
...
var nativeEvents = __webpack_require__(/*! ./native */ 24)
var pjaxEvents = __webpack_require__(/*! ./pjax */ 25)
var turbolinksEvents = __webpack_require__(/*! ./turbolinks */ 26)
var turbolinksClassicDeprecatedEvents = __webpack_require__(/*! ./turbolinksClassicDeprecated */ 27)
var turbolinksClassicEvents = __webpack_require__(/*! ./turbolinksClassic */ 28)
...
var fromRequireContext = __webpack_require__(/*! ./fromRequireContext */ 30)
...
var componentRequireContext = __webpack_require__(/*! components */ 19);
var ReactRailsUJS = __webpack_require__(/*! react_ujs */ 20);
ReactRailsUJS.useContext(componentRequireContext);

/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-3f77602faa443f061253.js.map