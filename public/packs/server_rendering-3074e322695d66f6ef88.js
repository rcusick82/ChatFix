...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (19:12)\n\n  17 |         this.props.watsonData.output.generic[1]\n  18 |           ? <h2 className=\"welcome-text\">{this.props.watsonData.output.generic[0].text}</h2>\n> 19 |             <h3 className=\"watson-question\">{this.props.watsonData.output.generic[1].title}</h3>\n     |             ^\n  20 |             {options}\n  21 | \n  22 |           : <p className=\"watson-options\">{this.props.watsonData.output.generic[0].title}</p>\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-3074e322695d66f6ef88.js.map