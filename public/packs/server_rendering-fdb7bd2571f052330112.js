  ...
  _createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      $.post("/conversations/add_message", {
        ...
        _this2.setState({ title: response.output.generic[0].text, options: response.output.generic[0].options });
      });
    }
  }, {
    key: "sendMessage",
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-fdb7bd2571f052330112.js.map